...
public class InitScript {
    private final static String ROOT = "src/test/java/Chatbot/";
    ...
    public static void main(String[] args) throws SQLException, IOException {
        ...
        BufferedReader resetFile = new BufferedReader(new InputStreamReader(Objects.requireNonNull(InitScript.class.getClassLoader().getResourceAsStream("MySQL/Reset.sql"))));
