...
public interface XPATHS {
    ...
    String MESSAGE_LOADING_WHEEL = "//i[@aria-label='Loading...' and @aria-busy='true']";

    //Inputs
    String INPUT_BOX = "//div[@aria-label=\"Type a message, @name...\"]";
    String MENTIONS = "//div[@data-testid='mentions-contextual-layer']";
    String MESSAGE_SCROLL_AREA = "//div[contains(@class,'_4u-c _1wfr _9hq')]/div/div[contains(@class,'scrollable')]";

    //Messages
    String START_OF_CHAT = "//div[contains(text(),'Start of chat')]";
